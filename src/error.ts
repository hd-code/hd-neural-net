...
function sum(actual: number[], expected: number[], func: (actual: number, expected: number) => number): number {
    let result = 0;
...
function sumDeriv(actual: number[], expected: number[], func: (actual: number, expected: number) => number): number[] {
    const result = [];
    for (let i = 0, ie = actual.length; i < ie; i++) {
...
function mean(actual: number[], expected: number[], func: (actual: number, expected: number) => number): number {
    return sum(actual, expected, func) / actual.length;
}

function meanDeriv(actual: number[], expected: number[], func: (actual: number, expected: number) => number): number[] {
