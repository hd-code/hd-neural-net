...
describe('init', () => {
    ...
    describe('4) 2,2,3,2 Net all binary as actFunc', () => {
        let net = fcl.init(2, {actFunction: actFunc.EActFunction.BINARY,numOfNeurons: 2},
            [{actFunction: actFunc.EActFunction.BINARY, numOfNeurons: 2}, {actFunction: actFunc.EActFunction.BINARY, numOfNeurons: 3}])
